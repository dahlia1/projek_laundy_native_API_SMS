$(document).ready(function() {
    ...
    let operateQtyPesanan = function(targetQty, operator = '', targetSubtotal, operate = 1) {
        ...
        totalch=parseFloat($("#inputanongkos").val());
    ...
    $(document).ready(function(){
    $("#inputanongkos").on("input", function(){
        total=0;
        totalch=parseFloat($(this).val());
    ...
    let updateTotal = function() {
        ...
        if ($('#antar').is(':checked')) {
            ...
            $('#inputanongkos').removeAttr("hidden");
            $('#lbong').removeAttr("hidden");
            total = total + parseFloat($('#inputanongkos').val());
                 $('#lbong').show();  
                 $('#inputanongkos').show();
            ...
            $('#lbong').attr("value",totalch);
            
            $('#lbong').attr("hidden",true);
                   
            $('#inputanongkos').attr("hidden",true);
        }
